...
#[command]
pub(crate) async fn bootstrap_voice<R: Runtime>(
    app: AppHandle<R>,
    payload: BootstrapRequest,
) -> Result<BootstrapResponse> {
    app.tauri_plugin_voice().bootstrap_voice(payload).await
}
...
pub(crate) async fn download_model<R: Runtime>(
    ...
    app.tauri_plugin_voice().download_model(payload)
}
...
pub(crate) async fn transcribe_file<R: Runtime>(
    ...
    app.tauri_plugin_voice().transcribe_file(payload).await
}

#[command]
pub(crate) async fn synthesize_speech<R: Runtime>(
    app: AppHandle<R>,
    payload: SynthesizeSpeechRequest,
) -> Result<SynthesizeSpeechResponse> {
    app.tauri_plugin_voice().synthesize_speech(payload).await
}

#[command]
pub(crate) async fn voice_health<R: Runtime>(
    app: AppHandle<R>,
    payload: HealthRequest,
) -> Result<HealthResponse> {
    app.tauri_plugin_voice().voice_health(payload)
}
    ...
    #[cfg(feature = "recorder-bridge")]
    {
        ...
        let res = app
            ...
            .start_recording(
                output_dir,
                file_name_prefix,
                tauri_plugin_recorder::TriggerSource::Manual,
            )
...
pub(crate) async fn stop_recording<R: Runtime>(
    ...
    #[cfg(feature = "recorder-bridge")]
    {
        ...
        let res = app
            .recorder()
            .stop_recording(session_id, tauri_plugin_recorder::TriggerSource::Manual)
            .map_err(|e| crate::Error::invalid_input(e.to_string()))?;
        convert_bridge_response(res)
    }
    #[cfg(not(feature = "recorder-bridge"))]
...
pub(crate) async fn set_hotkey_bindings<R: Runtime>(
    ...
    #[cfg(feature = "recorder-bridge")]
    {
        ...
        let rec_config = tauri_plugin_recorder::RecorderConfig {
            ...
            hide_overlay_on_recording_stop: None,
        };
        let res = app
            .recorder()
...
pub(crate) async fn capture_hotkey<R: Runtime>(
    ...
    #[cfg(feature = "recorder-bridge")]
    {
        ...
        let res = app
            .recorder()
            .capture_hotkey(timeout_ms.unwrap_or(20000))
            .map_err(|e| crate::Error::invalid_input(e.to_string()))?;
        convert_bridge_response(res)
    }
    #[cfg(not(feature = "recorder-bridge"))]
...
pub(crate) async fn set_output_destination<R: Runtime>(
    ...
    #[cfg(feature = "recorder-bridge")]
    {
        ...
        let res = app
            .recorder()
            .set_output_destination(rec_policy, base_dir, subdir, file_pattern)
            .map_err(|e| crate::Error::invalid_input(e.to_string()))?;
        convert_bridge_response(res)
    }
    #[cfg(not(feature = "recorder-bridge"))]
...
pub(crate) async fn set_overlay_mode<R: Runtime>(
    ...
    #[cfg(feature = "recorder-bridge")]
    {
        ...
        let rec_mode = match overlay_mode {
            ...
            OverlayMode::Consumer { consumer_url } => {
                tauri_plugin_recorder::OverlayMode::Consumer { consumer_url }
            }
            OverlayMode::Disabled => tauri_plugin_recorder::OverlayMode::Disabled,
        };
        let res = app
            .recorder()
            .set_overlay_mode(rec_mode)
            .map_err(|e| crate::Error::invalid_input(e.to_string()))?;
        convert_bridge_response(res)
    }
    #[cfg(not(feature = "recorder-bridge"))]
